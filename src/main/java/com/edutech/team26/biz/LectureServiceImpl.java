...
//		LocalDate startEnrolmentDate = getLocalDate(lectureDTO.getEndEnrolmentDate());
//		LocalDate endEnrolmentDate = getLocalDate(lectureDTO.getEndEnrolmentDate());
//		LocalDate startStudyDate = getLocalDate(lectureDTO.getEndEnrolmentDate());
//		LocalDate endStudyDate = getLocalDate(lectureDTO.getEndEnrolmentDate());

		Lecture lecture = Lecture.builder()
				.lecture_id(lectureDTO.getLecture_id())
	...
	public boolean set(LectureDTO lectureDTO) {
		...
		Optional<Lecture> optionalLecture = lectureRepository.findById(lectureDTO.getLecture_id());
...
//
//	@Override
//	public ServiceResult req(TakeLectureInput takeLectureInput) {
//
//		ServiceResult result = new ServiceResult();
//
//		Optional<Lecture> optionalLecture = lectureRepository.findById(takeLectureInput.getLectureId());
//		if (!optionalLecture.isPresent()) {
...
//		Lecture lecture = optionalLecture.get();
//
//		String[] statusList = {TakeLecture.STATUS_REQ, TakeLecture.STATUS_COMPLETE};
//		long count = takeLectureRepository.countByLectureIdAndUserIdAndStatusIn(
//				lecture.getId(), takeLectureInput.getUserId(), Arrays.asList(statusList));
//
//		if (count > 0) {
//			result.setResult(false);
...
//		}
//
//		TakeLecture takeLecture = TakeLecture.builder()
//									.lectureId(lecture.getId())
//									.userId(takeLectureInput.getUserId())
//									.payPrice(lecture.getSalePrice())
//									.createAt(LocalDateTime.now())
//									.status(TakeLecture.STATUS_REQ)
//									.build();
//
